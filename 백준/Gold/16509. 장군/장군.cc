...
int visited[10][9];
vector<int> dx[8] = { {-1,-2,-3},{0,-1,-2},{0,1,2},{1,2,3},{1,2,3},{0,1,2},{0,-1,-2},{-1,-2,-3} };
vector<int> dy[8] = { {0,1,2},{1,2,3},{1,2,3},{0,1,2},{0,-1,-2}, {-1,-2,-3},{-1,-2,-3},{0,-1,-2} };
...
void solve() {
    ...
    while (!q.empty()) {
        ...
        for (int dir = 0; dir < 8; dir++) {
            ...
            for (int i = 0; i < 2; i++) {
                int mx = x + dx[dir][i];
                int my = y + dy[dir][i];
                if (mx == e.first && my == e.second) b = true;
            }
            if (b) continue;
    ...
    cout << visited[e.first][e.second] - 1;
