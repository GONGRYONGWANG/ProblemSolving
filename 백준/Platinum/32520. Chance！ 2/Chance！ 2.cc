...
void solve() {
    ...
    while (!q.empty()) {
        ...
        if (abs(x * 2) <= 500 && abs(y * 2) <= 500 && dist[x * 2 + 500][y * 2 + 500][(d + 1) % 4] == -1) {
            dist[(x * 2) + 500][(y * 2) + 500][(d + 1) % 4] = d + 1;
            q.push({ x * 2,y * 2,d + 1 });
        }

        if (x + 1 <= 500 && dist[x + 1 + 500][y + 500][(d + 1) % 4] == -1) {
            dist[x + 1 + 500][y + 500][(d + 1) % 4] = d + 1;
            q.push({ x + 1,y,d + 1 });
        }

        if (dist[-y + 500][x + 500][(d + 1) % 4] == -1) {
            dist[-y + 500][x + 500][(d + 1) % 4] = d + 1;
            q.push({ -y,x,d + 1 });
        }
    }
    ...
    while (N--) {
        int K;
        cin >> K;
        if (dist[a + 500][b + 500][K % 4] == -1 || dist[a + 500][b + 500][K % 4] > K) {
            cout << "NO" << endl;
        }
        else cout << "YES" << endl;
    }
